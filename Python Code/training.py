...
num_epochs_to_train = 100 #each epoch adds about 600 iterations it seems
...
for epoch in range(num_epochs_to_train) :  
    ...
    #initialize batch_loss for each training batch
    batch_loss = 0.0
    ...
    #calls the testing function at the end of the epoch
    model_test(num_iterations, loss)
    
    #adding epoch-wide loss averaged across all batches
